...
!!! note "Instruction Priority Hierarchy"
    For a summary of the instruction priority hierarchy, see [Context & Baselines](../context/index.md#instruction-priority-hierarchy). This page expands on the layers with detailed configuration guidance.
...
The **[LLM Baseline Behaviors](../context/LLM-BaselineBehaviors.md)** document serves as the foundation. All agents should:
...
├─────────────────────────────────┤
│   Behavioral Baseline           │  ← docs/context/LLM-BaselineBehaviors.md
└─────────────────────────────────┘
```
...
agents/../context/LLM-BaselineBehaviors.md
...
- **[Baseline Behaviors](../context/LLM-BaselineBehaviors.md)** - Foundational behavioral model
...
1. Review the **[Baseline Behaviors](../context/LLM-BaselineBehaviors.md)** in detail
