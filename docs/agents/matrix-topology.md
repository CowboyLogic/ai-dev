...
| **Oracle** | `github-copilot/claude-opus-4.8` | Designer agent. Invoked at the design stage to define the user experience, validate the concept, and surface edge cases before any technical decisions are made. Invoke when defining what something does, how it feels, and what the user encounters at every step. | [oracle.md](https://github.com/CowboyLogic/ai-dev/blob/main/agents/matrix-topology/opencode/oracle.md) |
